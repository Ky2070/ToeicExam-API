...
urlpatterns = [
    ...
    path(
        "lessons/<int:lesson_id>/reviews/create/", create_review, name="create-review"
    ),
    ...
    path("blogs/<int:id>/v2/", blog_detail_v2, name="blog_detail_v2"),
    ...
    path(
        "panel/blogs/<int:id>/update/",
        BlogUpdateView.as_view(),
        name="panel_blog_update",
    ),
    path(
        "panel/blogs/<int:id>/delete/",
        BlogDeleteView.as_view(),
        name="panel_blog_delete",
    ),
    ...
    path(
        "panel/blogs/add-question-bank/<int:blog_id>/",
        panel_blog_question_bank,
        name="panel_blog_question_bank",
    ),
]
