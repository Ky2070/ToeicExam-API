...
from .views import TestDetailView, TestListView, TestPartDetailView, CourseListView, QuestionSkillAnalysisView, \
...
urlpatterns = [
    ...
    path('questions/skills/analyze/', QuestionSkillAnalysisView.as_view(), name='questions-skill-analyze'),
